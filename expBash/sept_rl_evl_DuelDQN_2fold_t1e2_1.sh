...
## This is the evaluation of DuelDQN RL agents in 2 fold setting, training on 1st, test on 2nd
 ## Evaluation
 echo '2fold DuelDQN RL training t1e2 evaluation'
 date +%Y,%m,%d-%H:%M:%S
 hist=3
 seedSet=2
 actSfxTem=1
...
## Let me try some t2e1 evaluation. 9/9/2018, by pwang8
 ## Evaluation
 echo '2fold DuelDQN RL training t2e1 evaluation'
 date +%Y,%m,%d-%H:%M:%S
 hist=3
 seedSet=2
 actSfxTem=1
