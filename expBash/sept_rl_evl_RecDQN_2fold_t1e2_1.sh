...
## This is the evaluation of Recurrent DQN RL agents in 2 fold setting, training on 1st, test on 2nd
 ## Evaluation
 echo '2fold t1e2 Recurrent DQN RL evaluation'
 date +%Y,%m,%d-%H:%M:%S
 hist=3
 seedSet=2
 actSfxTem=1
...
# Hi, I'm gonna do t2e1 evaluation for Recurrent DQN, 2fold setting

 ## Evaluation
 echo '2fold t2e1 Recurrent DQN RL evaluation'
 date +%Y,%m,%d-%H:%M:%S
 hist=3
 seedSet=2
 actSfxTem=1
