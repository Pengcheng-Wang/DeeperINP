...
## This is the evaluation of the linear RL agents (trained without any extra stabilization techniques) in 2 fold training, full set evaluation setting. training on 1st, test on full
 ## Evaluation
echo 'Linear RL (no stabilization) Train on 2fold1, test on full. Linear RL training evaluation'
 date +%Y,%m,%d-%H:%M:%S
 hist=3
 seedSet=2
 actSfxTem=1
