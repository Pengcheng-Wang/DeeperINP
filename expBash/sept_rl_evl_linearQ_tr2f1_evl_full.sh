...
## This is the evaluation of DuelDQN RL agents in 2 fold training, full set evaluation setting. training on 1st, test on full
 ## Evaluation
echo 'Train on 2fold1, test on full. Linear RL training evaluation'
 date +%Y,%m,%d-%H:%M:%S
 hist=3
 seedSet=2
 actSfxTem=1
