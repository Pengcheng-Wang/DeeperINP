...
#for rnnHdLc in 2
#do
#    echo 'in Bayesian RHN round' ${rnnHdLc}
#    date +%Y,%m,%d-%H:%M:%S
#    for t in 1 2;
#    do
#        for alr in 2e-4 5e-4 1e-3 5e-3;
...
#            if [ $t -eq 1 ];
#            then
#                th userSimMain.lua -trType ac -save rhn_alr_${alr}_hdlc_${rnnHdLc}/rnndrop.1/seed$(($s))/augRnd/tdiv$(($t))/ -batchSize 160 -coefL2 5e-3 -learningRate ${alr} -rnnHdSizeL1 21 -rnnHdLyCnt $(($rnnHdLc)) -rhnReccDept 8 -ciuTType train -uppModel rnn_rhn -lstmHist 10 -usimTrIte 8000  -uSimShLayer 0 -testSetDivSeed $(($t-1)) -gpu $(($g)) -dropoutUSim 0.1 -uSimLstmBackLen 3 -actPredDataAug 1 -seed $(($s)) > /dev/null &
#            else
#                th userSimMain.lua -trType ac -save rhn_alr_${alr}_hdlc_${rnnHdLc}/rnndrop.1/seed$(($s))/augRnd/tdiv$(($t))/ -batchSize 160 -coefL2 5e-3 -learningRate ${alr} -rnnHdSizeL1 21 -rnnHdLyCnt $(($rnnHdLc)) -rhnReccDept 8 -ciuTType train -uppModel rnn_rhn -lstmHist 10 -usimTrIte 8000  -uSimShLayer 0 -testSetDivSeed $(($t-1)) -gpu $(($g)) -dropoutUSim 0.1 -uSimLstmBackLen 3 -actPredDataAug 1 -seed $(($s)) > /dev/null &
#            fi
#        done
#    done
#    wait
#    echo 'done with in Bayesian RHN' ${rnnHdLc}
#    date +%Y,%m,%d-%H:%M:%S
#done


### Testing hyper-params for action prediction models
#echo 'in Bayesian RHN'
#date +%Y,%m,%d-%H:%M:%S
#for rnnHdLc in 3 4;
#do
#    for rhnRD in 5 8;
...
#done
#wait
#echo 'Done with in Bayesian RHN'
#date +%Y,%m,%d-%H:%M:%S


### Testing hyper-params for action prediction models. Dec 24, 2017
#echo 'in Bayesian RHN'
#date +%Y,%m,%d-%H:%M:%S
#for rnnHdLc in 3 4;
#do
...
#                if [ $t -eq 1 ];
#                then
#                    th userSimMain.lua -trType ac -save ac_rhn_res_alr_${alr}_hdlc_${rnnHdLc}_rhnRD_${rhnRD}/rnndrop.1/seed$(($s))/augRnd/tdiv$(($t))/ -batchSize 160 -coefL2 5e-3 -learningRate ${alr} -rnnHdSizeL1 21 -rnnHdLyCnt $(($rnnHdLc)) -rhnReccDept ${rhnRD} -rnnResidual 1 -ciuTType train -uppModel rnn_rhn -lstmHist 10 -usimTrIte 7000  -uSimShLayer 0 -testSetDivSeed $(($t-1)) -gpu $(($g)) -dropoutUSim 0.1 -uSimLstmBackLen 3 -actPredDataAug 1 -seed $(($s)) > /dev/null &
#                else
#                    th userSimMain.lua -trType ac -save ac_rhn_res_alr_${alr}_hdlc_${rnnHdLc}_rhnRD_${rhnRD}/rnndrop.1/seed$(($s))/augRnd/tdiv$(($t))/ -batchSize 160 -coefL2 5e-3 -learningRate ${alr} -rnnHdSizeL1 21 -rnnHdLyCnt $(($rnnHdLc)) -rhnReccDept ${rhnRD} -rnnResidual 1 -ciuTType train -uppModel rnn_rhn -lstmHist 10 -usimTrIte 7000  -uSimShLayer 0 -testSetDivSeed $(($t-1)) -gpu $(($g)) -dropoutUSim 0.1 -uSimLstmBackLen 3 -actPredDataAug 1 -seed $(($s)) > /dev/null &
#                fi
#            done
...
### Testing hyper-params for action prediction models. Dec 26, 2017
### Residual RHN is utilized here. rnnResidual version 2
#echo 'in Bayesian RHN'
#date +%Y,%m,%d-%H:%M:%S
#for rnnHdLc in 3 4;
#do
...
#                if [ $t -eq 1 ];
#                then
#                    th userSimMain.lua -trType ac -save ac_rhn_resV2_alr_${alr}_hdlc_${rnnHdLc}_rhnRD_${rhnRD}/rnndrop.1/seed$(($s))/augRnd/tdiv$(($t))/ -batchSize 160 -coefL2 5e-3 -learningRate ${alr} -rnnHdSizeL1 21 -rnnHdLyCnt $(($rnnHdLc)) -rhnReccDept ${rhnRD} -rnnResidual 1 -ciuTType train -uppModel rnn_rhn -lstmHist 10 -usimTrIte 7000  -uSimShLayer 0 -testSetDivSeed $(($t-1)) -gpu $(($g)) -dropoutUSim 0.1 -uSimLstmBackLen 3 -actPredDataAug 1 -seed $(($s)) > /dev/null &
#                else
#                    th userSimMain.lua -trType ac -save ac_rhn_resV2_alr_${alr}_hdlc_${rnnHdLc}_rhnRD_${rhnRD}/rnndrop.1/seed$(($s))/augRnd/tdiv$(($t))/ -batchSize 160 -coefL2 5e-3 -learningRate ${alr} -rnnHdSizeL1 21 -rnnHdLyCnt $(($rnnHdLc)) -rhnReccDept ${rhnRD} -rnnResidual 1 -ciuTType train -uppModel rnn_rhn -lstmHist 10 -usimTrIte 7000  -uSimShLayer 0 -testSetDivSeed $(($t-1)) -gpu $(($g)) -dropoutUSim 0.1 -uSimLstmBackLen 3 -actPredDataAug 1 -seed $(($s)) > /dev/null &
#                fi
#            done
...
### Get Action prediction result for fold 3-5. Dec 30, 2017.
#for rnnHdLc in 4
#do
#    echo 'in Bayesian LSTM fold 3-5' ${rnnHdLc}
#    date +%Y,%m,%d-%H:%M:%S
#    for t in 3 4 5;
#    do
#        for alr in 1e-3;
...
#            if [ $t -eq 1 ];
#            then
#                th userSimMain.lua -trType ac -save blstm_alr_${alr}_hdlc_${rnnHdLc}/rnndrop.1/seed$(($s))/augRnd/tdiv$(($t))/ -batchSize 160 -coefL2 5e-3 -learningRate ${alr} -rnnHdSizeL1 21 -rnnHdLyCnt $(($rnnHdLc)) -ciuTType train -uppModel rnn_blstm -lstmHist 10 -usimTrIte 3500  -uSimShLayer 0 -testSetDivSeed $(($t-1)) -gpu $(($g)) -dropoutUSim 0.1 -uSimLstmBackLen 3 -actPredDataAug 1 -seed $(($s)) > /dev/null &
#            else
#                th userSimMain.lua -trType ac -save blstm_alr_${alr}_hdlc_${rnnHdLc}/rnndrop.1/seed$(($s))/augRnd/tdiv$(($t))/ -batchSize 160 -coefL2 5e-3 -learningRate ${alr} -rnnHdSizeL1 21 -rnnHdLyCnt $(($rnnHdLc)) -ciuTType train -uppModel rnn_blstm -lstmHist 10 -usimTrIte 3500  -uSimShLayer 0 -testSetDivSeed $(($t-1)) -gpu $(($g)) -dropoutUSim 0.1 -uSimLstmBackLen 3 -actPredDataAug 1 -seed $(($s)) > /dev/null &
#            fi
#        done
...
#done
#wait
#echo 'Done with in Bayesian RHN fold 3-5'
#date +%Y,%m,%d-%H:%M:%S
#
#wait
### Action prediction models for fold 3-5
### Grid-LSTM is utilized here. Dec 30, 2017.
#echo 'in GridLSTM fold 3-5'
#date +%Y,%m,%d-%H:%M:%S
#for rnnHdLc in 4;
#do
#    for t in 3 4 5;
...
#done
#wait
#echo 'Done with GridLSTM fold 3-5'
#date +%Y,%m,%d-%H:%M:%S



## Testing hyper-params for action prediction models. Dec 24, 2017
echo 'Train Bayesian RHN layer 3 recurrent depth 3 learning rate 2e-3 for 2-fold cross-validation'
date +%Y,%m,%d-%H:%M:%S
s=1
for rnnHdLc in 3;
do
    ...
    do
        ...
        do
            ...
            do
                ...
                if [ $t -eq 1 ];
                then
                    th userSimMain.lua -trType ac -save ac_rhn_alr_${alr}_hdlc_${rnnHdLc}_rhnRD_${rhnRD}_2fold/rnndrop.1/seed$(($s))/augRnd/tdiv$(($t))/ -batchSize 160 -coefL2 5e-3 -learningRate ${alr} -rnnHdSizeL1 21 -rnnHdLyCnt $(($rnnHdLc)) -rhnReccDept ${rhnRD} -ciuTType train -uppModel rnn_rhn -lstmHist 10 -usimTrIte 2000  -uSimShLayer 0 -testSetDivSeed $(($t-1)) -gpu $(($g)) -dropoutUSim 0.1 -uSimLstmBackLen 3 -actPredDataAug 1 -seed $(($s)) -trainTwoFoldSim 1 > /dev/null &
                else
                    th userSimMain.lua -trType ac -save ac_rhn_alr_${alr}_hdlc_${rnnHdLc}_rhnRD_${rhnRD}_2fold/rnndrop.1/seed$(($s))/augRnd/tdiv$(($t))/ -batchSize 160 -coefL2 5e-3 -learningRate ${alr} -rnnHdSizeL1 21 -rnnHdLyCnt $(($rnnHdLc)) -rhnReccDept ${rhnRD} -ciuTType train -uppModel rnn_rhn -lstmHist 10 -usimTrIte 2000  -uSimShLayer 0 -testSetDivSeed $(($t-1)) -gpu $(($g)) -dropoutUSim 0.1 -uSimLstmBackLen 3 -actPredDataAug 1 -seed $(($s)) -trainTwoFoldSim 1 > /dev/null &
                fi
            done
...
wait
echo 'Done with in Bayesian RHN for 2-fold cv'
date +%Y,%m,%d-%H:%M:%S
