...
--function CIUserSimulator:UserSimActDataAugment(input, output_act, uppModelForm)
...
--        assert(input:dim()==3 and output_act:dim()==1, 'Input for CNN models in player simulator should be 3d')
