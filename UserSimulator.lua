    ...
    if isRNNForm then
        ...
        for i=1, self.opt.batchSize do
            ...
            elseif actStepCntTotal < 6 then
                ...
                freqActPertProb = {0.45, 0.1}--{0.3}
            elseif actStepCntTotal <= 20 then
                freqActPertProb = {0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1}--{0.7, 0.35}
            elseif actStepCntTotal <= 35 then
                freqActPertProb = {0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1}--{0.8, 0.5, 0.3}
            else
                freqActPertProb = {0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1}--{0.9, 0.7, 0.35}
            end
